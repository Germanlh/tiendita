...
<table> 
    ...
    /* PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP PHP */
        ...
        while($fila=$resultado->fetch_array(MYSQLI_BOTH)) {
            echo '<tr>';
            echo'
            <form method="POST" action="adminUSRmodifica.php" id="registrar_frm" name="registrar_frm" enctype="application/x-www-form-urlencoded">
            ...
            if($_SESSION['usr']!=$fila['mail']){
                echo '<td><a href="adminUSRelimina.php?mail='.$fila['mail'].'"><button>Borrar</button></a></td>';
            }
            echo '</tr>';
        }
    ...
    ?>
    <tr>
      <form method="POST" action="adminUSRagrega.php" id="agrega_frm" name="agrega_frm" enctype="application/x-www-form-urlencoded">
...
<a href="../tiendita.php">REGRESAR</a>
